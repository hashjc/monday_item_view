...
const FallbackForm = ({
    ...
    const handleSubmit = async (e) => {
        ...
        if (formAction === "create") {
            ...
            // In item view mode the active id comes from the itemId prop;
            // in board update mode it comes from selectedItemId.
            const activeId = selectedItemId || itemId;
            if (activeId) await updateItem(activeId, { name });
        }
    };
                            ...
                            <div className="relation-lookup-dropdown">
                                <div className="relation-lookup-header">
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            setMainItemLookup((p) => ({ ...p, isOpen: false }));
                                        }}
                                    >
                                        Close
                                    </button>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="section-container">
                            <div className="section-header">
                                <h3>
                                    Item Details <span className="field-count">(1 field)</span>
                                </h3>
                            </div>
...
const isFieldEmpty = (type, val) => {
    ...
    const updateItem = async (itemId, recordValues) => {
        ...
        try {
            ...
            // Refresh the form with the latest saved values
